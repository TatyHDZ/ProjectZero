...
public class CuerpoVentas extends javax.swing.JPanel {
Ventana ventana;
SQL db ;
Usuario empleado;
Sucursal sucursal;

    public CuerpoVentas(Ventana ventana, SQL db) {
        this.db = db;
        this.ventana = ventana;
        
        initComponents();
        empleado = db.getEmpleado();
        sucursal = db.getSucursal( empleado.getIdSucursal() );
    }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(servicio, javax.swing.GroupLayout.PREFERRED_SIZE, 82, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cliente, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void productoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_productoActionPerformed
       ventana.panelAccion.removeAll();
        ventana. panelAccion.add(  new WidgetBusqueda(db)  );
         this.updateUI();
